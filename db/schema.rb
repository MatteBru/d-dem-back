...
ActiveRecord::Schema.define(version: 20180122152559) do
  ...
  create_table "stances", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_stances_on_user_id"
    t.index ["view_id"], name: "index_stances_on_view_id"
  end
  ...
  create_table "views", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["creator_id"], name: "index_views_on_creator_id"
